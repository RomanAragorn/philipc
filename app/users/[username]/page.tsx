    ...
    return (
        <div className="dark:bg-gray-800">
            ...
            <div className="mx-auto max-w-7xl p-6">
                {/* User Info */}
                <div className="mb-6 flex items-center gap-4 rounded-2xl bg-linear-to-r from-[#003d4d]/85 to-[#0081b3]/85 px-8 py-5 shadow-xl dark:from-gray-900 dark:to-gray-900">
